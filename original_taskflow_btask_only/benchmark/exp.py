...
strname = ['des_perf_original_btask', 'vga_lcd_original_btask', 'tv80_original_btask', 'wb_dma_original_btask', 'aes_core_original_btask', 'ac97_ctrl_original_btask']
index = 0
for path in exp_path:
    file_path2 = path + 'original_btask_log_t2.txt'
    file_path3 = path + 'original_btask_log_t3.txt'
    file_path4 = path + 'original_btask_log_t4.txt'
    file_path5 = path + 'original_btask_log_t5.txt'
    file_path6 = path + 'original_btask_log_t6.txt'
    file_path7 = path + 'original_btask_log_t7.txt'
    file_path8 = path + 'original_btask_log_t8.txt'
    file_path9 = path + 'original_btask_log_t9.txt'
    file_path10 = path + 'original_btask_log_t10.txt'
    file_path11 = path + 'original_btask_log_t11.txt'
    file_path12 = path + 'original_btask_log_t12.txt'
    file_path13 = path + 'original_btask_log_t13.txt'
    file_path14 = path + 'original_btask_log_t14.txt'
    file_path15 = path + 'original_btask_log_t15.txt'
    file_path16 = path + 'original_btask_log_t16.txt'
    file_path17 = path + 'original_btask_log_t17.txt'
    file_path18 = path + 'original_btask_log_t18.txt'
    file_path19 = path + 'original_btask_log_t19.txt'
    file_path20 = path + 'original_btask_log_t20.txt'
